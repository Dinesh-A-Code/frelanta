...
export const Contact: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    // Simulate swift client inquiry handling
    setTimeout(() => {
      setSubmitting(false);
      setSubmitted(true);
    }, 600);
    ...
    >
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-6 bg-[#0D0D0D] border border-white/[0.08] p-8 sm:p-10 rounded-3xl">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="w-full mt-2 inline-flex items-center justify-center gap-2 bg-[#E8702A] hover:bg-[#D2611F] text-white py-4 rounded-xl font-medium text-sm transition-all duration-300 hover:scale-[1.01] active:scale-[0.99] disabled:opacity-50 shadow-lg shadow-[#E8702A]/20"
                >
                  {submitting ? (
